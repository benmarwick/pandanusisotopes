...
# Vegetation_ordered   2   3.92  1.9623   2.902 0.0588 .
# Residuals          121  81.83  0.6763                 
# ---
...
# between two environments at the edges
fit_env2 <- aov(`δ13CV-PDB (‰)` ~ Vegetation_ordered, 
          data = iso_results_veg %>% 
            filter(Vegetation %in% c("Floodplain fringe", 
                                     "Open forest and woodland")))  

summary(fit_env2)
#                    Df Sum Sq Mean Sq F value Pr(>F)  
# Vegetation_ordered  1   3.86   3.858   5.947 0.0174 *
# Residuals          67  43.47   0.649                 
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

apa::anova_apa(fit_env2)
